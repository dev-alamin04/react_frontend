...
function Hero() {
    ...
    return (
        <div className="bg-white text-black">
            ...
            {/* Top Hero */}
            <section className="bg-[#e8e8e8] text-center py-10 px-6 md:px-20 lg:px-40">
            ...
            <section className="max-w-[1680px] mx-auto px-6 py-12 flex flex-col md:flex-row gap-10">
                ...
                <div className="w-full md:w-1/2">
                    ...
                    {/* Subscribe Button */}
                    <button className="w-full bg-white border border-black text-black text-sm font-bold uppercase tracking-widest py-3 hover:bg-[#4F4F4F] hover:text-white hover:border-[#4F4F4F] transition-all duration-200">
                        {t('subscribe')}
                    </button>
                </div>
            </section>
